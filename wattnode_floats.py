...
print(client.port)
result = client.read_holding_registers(address=1032,count=2,unit=1)
print("WattNode Freq Registers 1033-1034:",result.registers)
decoder = BinaryPayloadDecoder.fromRegisters(result.registers,Endian.Big,Endian.Little)
print("Freq=",decoder.decode_32bit_float())
